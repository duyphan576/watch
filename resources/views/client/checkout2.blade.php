            ...
            <div class="box">
              <form method="POST" action="">
                ...
                <div class="nav flex-column flex-sm-row nav-pills"><a href="checkout1"
                    ...
                    href="checkout2" class="nav-link flex-sm-fill text-sm-center active"> <i class="fa fa-truck">
                    </i>Delivery Method</a><a href="#" class="nav-link flex-sm-fill text-sm-center disabled"> <i
                      class="fa fa-money"> </i>Payment Method</a><a href="#"
                    class="nav-link flex-sm-fill text-sm-center disabled"> <i class="fa fa-eye"> </i>Order Review</a>
                </div>
                ...
                <div class="box-footer d-flex justify-content-between"><a href="checkout1"
