            ...
            <div id="productMain" class="row">
              <div class="col-md-6">
                <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                  <div class="item"> <img src="User/img/detailbig1.jpg" alt="" class="img-fluid"></div>
                  <div class="item"> <img src="User/img/detailbig2.jpg" alt="" class="img-fluid"></div>
                  <div class="item"> <img src="User/img/detailbig3.jpg" alt="" class="img-fluid"></div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div data-slider-id="1" class="owl-thumbs">
                  <button class="owl-thumb-item"><img src="User/img/detailsquare.jpg" alt="" class="img-fluid"></button>
                  <button class="owl-thumb-item"><img src="User/img/detailsquare2.jpg" alt="" class="img-fluid"></button>
                  <button class="owl-thumb-item"><img src="User/img/detailsquare3.jpg" alt="" class="img-fluid"></button>
                </div>
              </div>
            </div>
