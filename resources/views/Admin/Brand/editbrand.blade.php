        ...
        <div class="content">
            ...
            <!-- Form Start -->
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3><a href="brand"><button type="button" class="btn btn-outline-primary m-2"><i class="fa fa-home me-2"></i>Back</button></a></h3>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3>Edit Brand</h3>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="brandtname" name="brandname"placeholder="Brand name">
                            <label for="floatingText">Brand Name</label>
                        </div>
                        
                        <div class="mb-3">
                                <label for="formFileMultiple" class="form-label">Imega Logo :</label>
