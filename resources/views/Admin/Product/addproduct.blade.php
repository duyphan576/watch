        ...
        <div class="content">
            ...
            <!-- Form Start -->
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3><a href="managerproduct"><button type="button" class="btn btn-outline-primary m-2"><i class="fa fa-home me-2"></i>Back</button></a></h3>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3>Add Product</h3>
                        </div>
                        ...
                        <div class="form-floating mb-4">
                                <select class="form-select" id="floatingSelect" aria-label="Floating label select example" id="brand" name="brand">
                        ...
                        <div class="form-floating mb-4">
                                <select class="form-select" id="floatingSelect" aria-label="Floating label select example" id="strap" name="strap">
