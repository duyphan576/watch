  ...
  <header class="header mb-5">
      ...
      *** TOPBAR ***
              ...
              <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <p class="text-center text-muted"><a href="register"><strong>Register now</strong></a>! It is
      ...
      <nav class="navbar navbar-expand-lg">
          <div class="container"><a href="index" class="navbar-brand home"><img src="User/img/logo.png"
                      alt="Obaju logo" class="d-none d-md-inline-block"><img src="User/img/logo-small.png"
                          ...
                          <ul class="dropdown-menu megamenu">
                              <li>
                                  <div class="row">
                                      ...
                                      <div class="col-md-6 col-lg-3">
                                          <div class="banner"><a href="#"><img src="User/img/banner.jpg"
                                                      alt="" class="img img-fluid"></a></div>
                                          <div class="banner"><a href="#"><img src="User/img/banner2.jpg"
                                                      alt="" class="img img-fluid"></a></div>
                                      </div>
                                  </div>
                              </li>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6 col-lg-3">
                                          ...
                                          <ul class="list-unstyled mb-3">
                                              ...
                                              <li class="nav-item"><a href="customer-account"
